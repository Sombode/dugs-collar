...
const lines = [
  new Audio("/voicelines/HITHERE.wav"),
  new Audio("/voicelines/YES.wav"),
  new Audio("/voicelines/COLLAR.wav"),
  new Audio("/voicelines/NAME.wav"),
  new Audio("/voicelines/SQUIRREL.wav")
];
